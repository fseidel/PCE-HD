...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" NUMWORDS_A=32768 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="DONT_CARE" WIDTH_A=16 WIDTH_BYTEENA_A=1 WIDTHAD_A=15 address_a clock0 data_a q_a wren_a
...
//VERSION_BEGIN 12.1 cbx_cycloneii 2012:11:07:18:03:20:SJ cbx_lpm_add_sub 2012:11:07:18:03:20:SJ cbx_lpm_compare 2012:11:07:18:03:20:SJ cbx_lpm_decode 2012:11:07:18:03:20:SJ cbx_mgl 2012:11:07:18:50:05:SJ cbx_stratix 2012:11:07:18:03:20:SJ cbx_stratixii 2012:11:07:18:03:20:SJ  VERSION_END

//synthesis_resources = lut 4 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  VRAM_synth_decode
	( 
	data,
	enable,
...
endmodule //VRAM_synth_mux

//synthesis_resources = lut 40 M9K 64 reg 4 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"OPTIMIZE_POWER_DURING_SYNTHESIS=NORMAL_COMPILATION"} *)
module  VRAM_synth_altsyncram
	( 
	address_a,
	clock0,
	data_a,
...
`endif
	...
	VRAM_synth_decode   decode3
	( 
	.data(address_a_wire[14:13]),
	.enable(wren_a),
	.eq(wire_decode3_eq));
	VRAM_synth_decode1   rden_decode
	( 
...
endmodule //VRAM_synth_altsyncram
//VALID FILE
...
`endif
	...
	VRAM_synth_altsyncram	VRAM_synth_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
				.wren_a (wren),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL VRAM_synth_syn.v TRUE
